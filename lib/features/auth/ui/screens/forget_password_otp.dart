...
import 'package:digifurniture/features/auth/ui/widgets/forget_password/forget_password_otp_view.dart';
...
class ForgetPassWordOtp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return BusyOverlay(
      show: forgetPassWatch.otpLoading,
      child: Scaffold(
        body: SafeArea(
          child: Column(
            ...
            children: [
              ...
              const Expanded(child: ForgetPasswordOtpView()),
            ],
          ),
        ),
      ),
