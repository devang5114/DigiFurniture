...
class ForgetPasswordOtpView extends ConsumerWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                forgetPassWatch.email.split('@')[0] +
                    '**@' +
                    forgetPassWatch.email.split('@')[1],
                style: TextStyle(fontSize: 14.sp, color: Colors.grey),
              ),
              TextButton(
                  onPressed: () {},
                  child: Text(
                    appString.keyChangeYourEmail,
          ...
          Row(
            children: [
              ...
              Expanded(
                child: CommonButton(
                    onTap: () {
                      forgetPassWatch.verifyOtp(context);
                    },
                    fontWeight: FontWeight.w500,
                    fontSize: 17.sp,
